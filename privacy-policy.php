    ...
    <div class="row py-3">
        <div class="col-12 col-md-8">
            <div class="card p-3">
                ...
                <p>Our website address is: https://finderorg.com.</p>

                <h3>What personal data we collect and why we collect it</h3>

                <p>At finderorg, accessible from finderorg.com, one of our main priorities is the privacy of our
                    visitors.
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with
                    regards to the information that they shared and/or collect in finderorg. This policy is not
                    applicable
                ...
                <p>finderorg follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Like any other website, finderorg uses &lsquo;cookies. These cookies are used to store information
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are
                    used in their respective advertisements and links that appear on finderorg, which are sent directly
                    to
                ...
                <p>Note that finderorg has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h3>Third Party Privacy Policies</h3>

                <p>finderorgs Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                    to
                ...
                <p>Request that a business that collects a consumers personal data disclose the categories and specific
                ...
                <p>Request that a business that sells a consumers personal data, not sell the consumers personal data.
                </p>
                ...
                <p>finderorg does not knowingly collect any Personal Identifiable Information from children under the
                    age of
                ...
                <p>When visitors leave comments on the site we collect the data shown in the comments form, and also the
                    visitors IP address and browser user agent string to help spam detection.</p>
                ...
                <p>If you have any questions and suggestion, feel free to drop an
                    email:&nbsp;<strong>info@finderorg.com</strong></p>

                <p><strong>Last modified: May 11, 2022</p>
            </div>
        </div>
